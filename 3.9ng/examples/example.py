    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.freq_xlating_fir_filter_xxx_0_0 = filter.freq_xlating_fir_filter_ccc(N, taps, -100000, samp_rate)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(N, taps, 200000, samp_rate)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '../../3.8ng/examples/gr-acars_1.152M_2.bin', False, 0, 0)
        ...
        self.acars_acars_0_1 = acars.acars(3, '/tmp/logm100', False)
        self.acars_acars_0_0 = acars.acars(3, '/tmp/logp200', False)
        ...
        self.connect((self.analog_am_demod_cf_0_0, 0), (self.acars_acars_0_1, 0))
        self.connect((self.analog_am_demod_cf_0_1, 0), (self.acars_acars_0_0, 0))
        ...
        self.connect((self.freq_xlating_fir_filter_xxx_0, 0), (self.analog_am_demod_cf_0_1, 0))
        self.connect((self.freq_xlating_fir_filter_xxx_0_0, 0), (self.analog_am_demod_cf_0_0, 0))
